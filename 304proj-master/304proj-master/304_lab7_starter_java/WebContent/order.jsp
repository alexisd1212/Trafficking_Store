...
else
{
	...
	try
	{
		...
		{	custName = rst.getString(2);
			...
			out.println("<h1>Order summary.  Proceed to shipping</h1>");
			out.println("<h1>Your order reference number is: "+orderId+"</h1>");
			// out.println("<h1>Shipping to customer: "+custId+" Name: "+custName+"</h1>");

			out.println("<h2><a href=\"index.jsp\">Return to Main Page</a></h2>");
			out.println("<h2><a href=\"shipment.jsp\">Proceed to shipping</a></h2>");
